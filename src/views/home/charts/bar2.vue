        ...
        if(dom) {
          ...
          const options = {
            baseOption: {
              ...
              legend: {
                x: 'right',
                data: ['顺丰', '24ud', '申通', '韵达', 'EMS', '中通'],
                selected: {
                  '韵达': false, 'EMS': false, '中通': false
                }
              },
              calculable : true,
              grid: {
            ...
            options: [
              {
                title: {text: '2002快递企业业务量、业务收入统计及增长情况'},
                series: [
                  ...
                  {data: [
                      {name: '顺丰', value: dataMap.dataPI['2002sum']},
                      {name: '24ud', value: dataMap.dataSI['2002sum']},
                      {name: '申通', value: dataMap.dataTI['2002sum']}
                    ]}
                ]
              },
              {
                title : {text: '2003快递企业业务量、业务收入统计及增长情况'},
                series : [
                  ...
                  {data: [
                      {name: '顺丰', value: dataMap.dataPI['2003sum']},
                      {name: '24ud', value: dataMap.dataSI['2003sum']},
                      {name: '申通', value: dataMap.dataTI['2003sum']}
                    ]}
                ]
              },
              {
                title : {text: '2004快递企业业务量、业务收入统计及增长情况'},
                series : [
                  ...
                  {data: [
                      {name: '顺丰', value: dataMap.dataPI['2004sum']},
                      {name: '24ud', value: dataMap.dataSI['2004sum']},
                      {name: '申通', value: dataMap.dataTI['2004sum']}
                    ]}
                ]
              },
              {
                title : {text: '2005快递企业业务量、业务收入统计及增长情况'},
                series : [
                  ...
                  {data: [
                      {name: '顺丰', value: dataMap.dataPI['2005sum']},
                      {name: '24ud', value: dataMap.dataSI['2005sum']},
                      {name: '申通', value: dataMap.dataTI['2005sum']}
                    ]}
                ]
              },
              {
                title : {text: '2006快递企业业务量、业务收入统计及增长情况'},
                series : [
                  ...
                  {data: [
                      {name: '顺丰', value: dataMap.dataPI['2006sum']},
                      {name: '24ud', value: dataMap.dataSI['2006sum']},
                      {name: '申通', value: dataMap.dataTI['2006sum']}
                    ]}
                ]
              },
              {
                title : {text: '2007快递企业业务量、业务收入统计及增长情况'},
                series : [
                  ...
                  {data: [
                      {name: '顺丰', value: dataMap.dataPI['2007sum']},
                      {name: '24ud', value: dataMap.dataSI['2007sum']},
                      {name: '申通', value: dataMap.dataTI['2007sum']}
                    ]}
                ]
              },
              {
                title : {text: '2008快递企业业务量、业务收入统计及增长情况'},
                series : [
                  ...
                  {data: [
                    {name: '顺丰', value: dataMap.dataPI['2008sum']},
                      {name: '24ud', value: dataMap.dataSI['2008sum']},
                      {name: '申通', value: dataMap.dataTI['2008sum']}
                    ]}
                ]
              },
              {
                title : {text: '2009快递企业业务量、业务收入统计及增长情况'},
                series : [
                  ...
                  {data: [
                     {name: '顺丰', value: dataMap.dataPI['2009sum']},
                      {name: '24ud', value: dataMap.dataSI['2009sum']},
                      {name: '申通', value: dataMap.dataTI['2009sum']}
                    ]}
                ]
              },
              {
                title : {text: '2010快递企业业务量、业务收入统计及增长情况'},
                series : [
                  ...
                  {data: [
                    {name: '顺丰', value: dataMap.dataPI['20010sum']},
                      {name: '24ud', value: dataMap.dataSI['20010sum']},
                      {name: '申通', value: dataMap.dataTI['20010sum']}
                    ]}
                ]
              },
              {
                title : {text: '2011快递企业业务量、业务收入统计及增长情况'},
                series : [
                  ...
                  {data: [
                    {name: '顺丰', value: dataMap.dataPI['20011sum']},
                      {name: '24ud', value: dataMap.dataSI['20011sum']},
                      {name: '申通', value: dataMap.dataTI['20011sum']}
                    ]}
                ]
              }
            ]
