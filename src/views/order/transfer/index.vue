...
export default {
  ...
  computed: {
    ...
    setting() {
      ...
      console.log('=======',ARGS, CurrentModule)
      return {
        ...ARGS,
  ...
  methods: {
    ...
    handleModuleChange(modules, options, columns, operations) {
      console.log('options', modules,options, columns, operations)
      this.moduleType = {
        ...modules
      }
      this.params = {
     ...
     this.state = modules.state
      console.log('this.detailContent', this.detailContent, columns);
      this.configFilters = []
      this.columns = []
      this.$nextTick(() => {
    ...
    handleListenSelectRows(rowkeys, dataSource) {
      ...
      console.log(rowkeys, dataSource)
