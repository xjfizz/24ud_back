  ...
  <section class="detail-wrapper">
    <dl class="detail-item">
      ...
      <dd>
        ...
        <span class="detail-text">{{row.name}} {{row.sex ? '女': '男'}} {{row.phone}}</span>
      </dd>
      <dd>
      ...
      <template v-if="row.type === 0">
        <dd>
          ...
          <span class="detail-text">{{row.courier.branches | formatId2Label(id2labels) }}</span>
        </dd>
        <dd>
          <span class="detail-label">所属区域</span>
          <span class="detail-text">{{row.courier.area | formatId2Label(id2labels) }}</span>
        </dd>
      </template>
      <template v-else>
        <dd>
