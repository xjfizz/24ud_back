   ...
   <a-modal :title="modelOptions.title" v-model="modelOptions.visible" @ok="submit" :width="700" @cancel="cancel">
     <a-form :form="form">
       <a-row>
        ...
        <a-input placeholder="请输入账号名称" v-decorator="['userName',{ rules:[{required: true, message: '请输入账号名称'}]}]"></a-input>
     </a-form-item>
         </a-col>
         <a-col :span="12">
      ...
      <a-row>
         <a-col :span="12">
          <a-form-item label="密码" :label-col="{span: 8}" :wrapper-col="{span:15}">
            <a-input placeholder="请输入密码" v-decorator="['password',{ rules:[{required: true, message: '请输入账号密码'}]}]"></a-input>
          </a-form-item>
         </a-col>
         <a-col :span="12">
